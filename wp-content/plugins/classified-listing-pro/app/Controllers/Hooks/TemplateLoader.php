...
class TemplateLoader
{
    ...
    private static function get_template_loader_default_file() {
        ...
        } elseif (is_post_type_archive(rtcl()->post_type) || is_page(Functions::get_page_id('listings'))) {
            $default_file = 'archive-' . rtcl()->post_type . '.php';
        }
    ...
    public static function comments_template_loader($template) {
        ...
        if ($template_file = locate_template($checkFiles)) {
            ...
            $file = trailingslashit(rtcl()->plugin_path()) . 'templates/single-rtcl_listing-reviews.php';
            if (file_exists($file)) {
                return $file;
            }
        }
