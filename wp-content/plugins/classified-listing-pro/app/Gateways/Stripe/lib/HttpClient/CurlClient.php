...
namespace Rtcl\Gateways\Stripe\lib\HttpClient;

use Rtcl\Gateways\Stripe\lib\Error\Api;
use Rtcl\Gateways\Stripe\lib\Error\ApiConnection;
...
class CurlClient implements ClientInterface
{
    ...
    public function request($method, $absUrl, $headers, $params, $hasFile)
    {
        ...
        if (is_callable($this->defaultOptions)) { // call defaultOptions callback, set options to return value
            ...
            if (!is_array($opts)) {
                throw new Api("Non-array value returned by defaultOptions CurlClient callback");
            }
        ...
        if ($method == 'get') {
            ...
            throw new Api("Unrecognized method $method");
        }
