                ...
                <table cellpadding="0" cellspacing="0" class="rtcl_payment_items">
                    ...
                    <tr>
                        <td class="rtcl_payment_item_details">
                            <?php do_action('rtcl_payment_item_details', $payment->get_id(), $payment); ?>
                        </td>
                        ...
                        <td class="rtcl_promotions">
                            <?php do_action('rtcl_payment_promotions_content', $payment->get_id(), $payment); ?>
                        </td>
                        <td class="price"><?php echo $payment->pricing ? Functions::get_formatted_price($payment->pricing->getPrice(),
                                true) : ''; ?></td>
                    </tr>
                    </tbody>
                </table>
