...
class Listings
{
    ...
    protected function parse_attributes($attributes) {
        ...
        $attributes = shortcode_atts(
            array(
                ...
                'view'              => !empty($general_settings['default_view']) ? $general_settings['default_view'] : 'list',
                'map'               => 0,
                'authors'           => '',
                'filterby'          => '',
                'top_listing'       => false
    ...
    protected function listing_loop() {
         ...
         * Top listings
         */
        if ($this->attributes['top_listing'] && Functions::is_enable_top_listings()) {
            do_action('rtcl_top_listings');
        }
        $top_listings = ob_get_clean();
        ...
        return sprintf('<div class="%s"><div class="rtcl-listings-wrapper">%s</div>%s</div>',
