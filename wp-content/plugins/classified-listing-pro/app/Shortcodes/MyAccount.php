...
use Rtcl\Emails\EmailUserResetPasswordNotificationUser;
...
class MyAccount
{
    ...
    public static function chat_conversations() {
        Functions::get_template("myaccount/chat-conversation");
    }
    ...
    public static function edit_account() {
        ...
        $data['latitude'] = get_user_meta($user_id, '_rtcl_latitude', true);
        $data['longitude'] = get_user_meta($user_id, '_rtcl_longitude', true);
