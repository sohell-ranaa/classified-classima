...
trait ListingTrait {
	...
	static function is_gallery_slider_enabled() {
		...
		return apply_filters( 'rtcl_single_listing_slider_enabled', isset( $misc_settings['disable_gallery_slider'] ) && $misc_settings['disable_gallery_slider'] == 'yes' ? false : true );
	}
