...
(function ($) {
  ...
  var responseHolder = $('<div class="response-item"><div class="progress"><div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">0%</div></div><div class="response"></div></div>');

  if ($.fn.validate) {
    var getDataLength = function getDataLength(data) {
    ...
    var insertData = function insertData(data, action, text) {
      if (data && !data.length) {
        return;
      }

      var responseTarget = $("#import-response"),
        ...
        return new Promise(function (resolve, reject) {
          $.ajax({
            ...
            success: function success(res) {
              var target = responseText.find('.alert');
      ...
      function insertDataItem(dataItem, parent) {
        var index, item, itemObj, response;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function insertDataItem$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                _context.next = 9;
                return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(insertAjaxCall(itemObj));
...
/***/ 1:
/*!**********************************!*\
  !*** multi ./src/js/admin-ie.js ***!
  \**********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/mahbubur/projects/classified-listing-pro/src/js/admin-ie.js */"./src/js/admin-ie.js");
