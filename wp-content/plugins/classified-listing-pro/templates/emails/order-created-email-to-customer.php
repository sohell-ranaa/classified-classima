...
do_action( 'rtcl_email_header', $email ); ?>
    ...
    <p><?php printf( __( 'This notification was for the order <strong>#%s</strong> on the website <strong>%s</strong>', 'classified-listing' ), $order->get_id(), $email->get_placeholders_item( '{site_link}' ) ) ?></p>
